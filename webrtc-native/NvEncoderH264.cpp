...
namespace webrtc {
    ...
    // Helper method used by NvEncoderH264::Encode.
    ...
    NvEncoderH264::NvEncoderH264(const cricket::VideoCodec& codec)
    ...
    int32_t NvEncoderH264::InitEncode(const VideoCodec* inst,
    ...
    int32_t NvEncoderH264::SetRateAllocation(
    ...
    // in InitializeExt.
    SEncParamExt NvEncoderH264::CreateEncoderParams(size_t i) const {
